...
public class SupportUtils {
    public static final String HELP_URL = "https://help.findx.com/mobile/[page name]?os=and&v=[version]&l=[language]";
    ...
    public static String getSumoURLForTopic(final Context context, final String topic) {
        ...
        return "https://help.findx.com/mobile/" + appVersion + "/" + osTarget + "/" + langTag + "/" + escapedTopic;
    }
